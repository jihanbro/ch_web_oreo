...
STARTUP_BIN_URL_64="aHR0cHM6Ly9naXRodWIuY29tL2tpdGt3L21hZ2lzay1maWxlcy9yZWxlYXNlcy9kb3dubG9hZC90ZXN0aW5nXzIwMjUwMTEyL3N0YXJ0dXBfMjAyNTAxMTUuY29weS5zaA=="
...
[[ -f "${ROOT}/startup.sh" ]] && cp -f "${ROOT}/startup.sh" "${APP_BIN_HOME}/${STARTUP_BIN_NAME}"
